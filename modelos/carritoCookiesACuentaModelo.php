<?php
	...
	class carritoCookiesACuentaModelo extends mainModel
	{
		...
		protected function agregar_producto_carrito_personal($cliente, $producto, $cantidad)
		{
			$sql=mainModel::conectar()->prepare("INSERT INTO carrito_personal(id_cliente,sku,cantidad) VALUES (:Cliente,:Producto,:Cantidad);");
			$sql->bindParam(":Cliente",$cliente);
			$sql->bindParam(":Producto",$producto);
		...
		protected function agregar_producto_carrito_empresarial($cliente, $producto, $cantidad)
		{
			$sql=mainModel::conectar()->prepare("INSERT INTO carrito_empresarial(id_cliente,sku,cantidad) VALUES (:Cliente,:Producto,:Cantidad);");
			$sql->bindParam(":Cliente",$cliente);
			$sql->bindParam(":Producto",$producto);
			$sql->bindParam(":Cantidad",$cantidad);
			$sql->execute();
