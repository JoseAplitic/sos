		...
		<div class="carrito-contenedor boxed-width">
			...
			<div class="carrito-items">
				...
				<div class="row item">
					<div class="column producto w60">
						<div class="imagen"><a href="#"><img src="<?php echo SERVERURL; ?>vistas/assets/img/404-page.jpg" alt="a"></a></div>
						<div class="texto"><a href="#"><h3 class="nombre">Titulo</h3><p class="sku">KKKSMMAS</p></a></div>
					</div>
					<div class="column precio w20"><p>Q12.00</p></div>
					<div class="column cantidad w20"><p>1</p></div>
					<div class="column subtotal w20"><p>Q12.00</p></div>
				</div>
				<div class="row item">
					<div class="column producto w60">
						<div class="imagen"><a href="#"><img src="<?php echo SERVERURL; ?>vistas/assets/img/404-page.jpg" alt="a"></a></div>
			...
			<div class="total-contenedor">
				<div class="total">
					...
					<div class="numero-total"><p>Q10,300.00</p></div>
					<?php
						$enlaceCarrito = "";
						$textoCarrito = "";
					...
					?>
					<div class="enlace"><a href="<?php echo $enlaceCarrito; ?>"><?php echo $textoCarrito; ?></a></div>
				</div>
			</div>
		</div>
