	...
	<main class="full-width">
		...
		<style type="text/css">
			...
			main .home-element-1 .categories .menu{max-height: 492px;overflow-y: auto;}
			...
			main .home-element-1 .categories .menu ul > li > a{display: flex !important;flex-flow: row wrap;align-items: center;text-decoration: none;}
			main .home-element-1 .categories .menu ul > li > a > img{display: flex;flex: 0 0;width: 25px;margin-right: 10px;max-height: 25px;}
			main .home-element-1 .categories .menu ul > li > a > span{display: flex;flex: 1 0;font-size: 18px;font-weight: normal;}
			main .home-element-1 .categories .menu ul li a{color: #4d4d4d;position: relative;display: block;padding: 12px 27px 12px 15px;}
			...
			main .home-element-2 .categories .categories-slideshow .categories-item .categorie a{text-decoration:none;}
			main .home-element-2 .categories .categories-slideshow .categories-item .categorie h3{color: #fff;text-transform: uppercase;text-align: center;font-size:11pt;}
		...
		<div class="home-element-2 boxed-width">
			<div class="categories">
				...
				<div class="categories-slideshow">
					<?php echo $instaciaHome->cargar_categorias_slider_controlador(); ?>
				</div>
			</div>
		</div>
    </main>